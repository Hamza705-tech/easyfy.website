    ...
    return (
        <div className='p-5' >
            ...
            <ul>
                ...
                <li>
                    <p><strong>Website</strong> refers to easyfy, accessible from <a href="https://easyfy.website" rel="external nofollow noopener" target="_blank">https://easyfy.website</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By visiting this page on our website: <a href="https://easyfy.website" rel="external nofollow noopener" target="_blank" className=' underline text-blue-700 '>www.easyfy.website</a></li>
            </ul>
        </div>
    )
}
