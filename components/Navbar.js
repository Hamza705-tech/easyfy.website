  ...
  return (
    <nav className="h-20 bg-gradient-to-t from-teal-700 to-emerald-600 flex flex-col md:flex-row justify-between items-center px-3 text-white  ">
      ...
      <ul className="flex flex-wrap justify-center md:justify-start gap-3 md:gap-4 items-center w-full md:w-auto">
        <li>
          <Link href="/">
            <span className="hover:text-green-300 hover:font-bold transition-all">Home</span>
          </Link>
        </li>
        <li>
          <Link href="/about">
            <span className="hover:text-green-300 hover:font-bold transition-all">About</span>
          </Link>
        </li>
        <li>
          <Link href="/shorten">
            <span className="hover:text-green-300 hover:font-bold transition-all">Generate</span>
          </Link>
        </li>
        <li>
          <Link href="/contact">
            <span className="hover:text-green-300 hover:font-bold transition-all">Contact Us</span>
          </Link>
        </li>
      </ul>
